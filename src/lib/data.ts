...
export const studentNavItems: NavItem[] = [
  ...
  { title: 'Sports', href: '/sports', icon: Dribbble },
  ...
  { title: 'Lost & Found', href: '/lost-and-found', icon: Search },
...
export const canteenItems = [
  ...
  { name: 'Iced Coffee', price: 80, image: 'https://images.unsplash.com/photo-1517701550927-30cf4ba1dba5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxfHxpY2VkJTIwY29mZmVlfGVufDB8fHx8fDE3NTc2Njg5MTl8MA&ixlib=rb-4.1.0&q=80&w=1080', dataAiHint: 'iced coffee' },
...
export const allCanteenItems = {
  snacks: [
    ...
    { id: 7, name: 'Noodles', price: 40, image: 'https://images.unsplash.com/photo-1585032226651-759b368d7246?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwyfHxub29kbGVzfGVufDB8fHx8fDE3NTc2NjcwMTl8MA&ixlib=rb-4.1.0&q=80&w=1080', dataAiHint: 'noodles' },
...
export const events = [
  ...
  { id: 5, title: 'Beach Cleanup Drive', slug: 'beach-cleanup-drive', category: 'Volunteer', date: 'Dec 25', image: 'https://images.unsplash.com/photo-1618477462028-dd464cf363dd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxOXx8YmVhY2glMjBjbGVhbnVwJTIwZHJpdmV8ZW58MHx8fHwxNzU4ODEzODA2fDA&ixlib=rb-4.1.0&q=80&w=1080', dataAiHint: 'beach cleanup' },
  { id: 6, title: 'Teach for a Day', slug: 'teach-for-a-day', category: 'Volunteer', date: 'Dec 28', image: 'https://images.unsplash.com/photo-1561089489-f13d5e730d72?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxOXx8dGVhY2glMjBmb3IlMjBhJTIwZGF5fGVufDB8fHx8fDE3NTg4MTM4NDB8MA&ixlib=rb-4.1.0&q=80&w=1080', dataAiHint: 'teaching children' },
];
...
export const sportsData: { cricket: Sport, football: Sport, basketball: Sport } = {
    cricket: {
        name: 'Cricket',
        fixtures: [
            { id: 1, time: '3:00 PM Today', status: 'live', teamA: { name: 'CS Strikers', score: 145 }, teamB: { name: 'Mech Mavericks', score: 102 } },
            { id: 2, time: '5:00 PM Today', status: 'upcoming', teamA: { name: 'Civil Challengers', score: 0 }, teamB: { name: 'ECE Eagles', score: 0 } },
        ],
        standings: [
            { position: 1, teamName: 'CS Strikers', played: 5, won: 4, drawn: 0, lost: 1, points: 12 },
            { position: 2, teamName: 'Mech Mavericks', played: 5, won: 3, drawn: 1, lost: 1, points: 10 },
            { position: 3, teamName: 'ECE Eagles', played: 5, won: 2, drawn: 1, lost: 2, points: 7 },
            { position: 4, teamName: 'Civil Challengers', played: 5, won: 0, drawn: 0, lost: 5, points: 0 },
        ]
    },
    football: {
        name: 'Football',
        fixtures: [
            { id: 1, time: '4:00 PM Today', status: 'live', teamA: { name: 'Business Blazers', score: 2 }, teamB: { name: 'Arts United', score: 1 } },
        ],
        standings: [
            { position: 1, teamName: 'Business Blazers', played: 3, won: 3, drawn: 0, lost: 0, points: 9 },
            { position: 2, teamName: 'Science FC', played: 3, won: 2, drawn: 0, lost: 1, points: 6 },
            { position: 3, teamName: 'Arts United', played: 3, won: 1, drawn: 0, lost: 2, points: 3 },
            { position: 4, teamName: 'Law Legends', played: 3, won: 0, drawn: 0, lost: 3, points: 0 },
        ]
    },
    basketball: {
        name: 'Basketball',
        fixtures: [
             { id: 1, time: '6:00 PM Today', status: 'upcoming', teamA: { name: 'Design Dunkers', score: 0 }, teamB: { name: 'Pharma Phenoms', score: 0 } },
        ],
        standings: [
            { position: 1, teamName: 'Design Dunkers', played: 4, won: 4, drawn: 0, lost: 0, points: 12 },
            { position: 2, teamName: 'Medical Monsters', played: 4, won: 2, drawn: 0, lost: 2, points: 6 },
            { position: 3, teamName: 'Pharma Phenoms', played: 4, won: 2, drawn: 0, lost: 2, points: 6 },
            { position: 4, teamName: 'Arch. All-Stars', played: 4, won: 0, drawn: 0, lost: 4, points: 0 },
        ]
    }
};
