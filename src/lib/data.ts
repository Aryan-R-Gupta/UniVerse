...
export const allCanteenItems = {
  ...
  meals: [
    ...
    { id: 6, name: 'Chole Bhature', price: 90, image: 'https://images.unsplash.com/photo-1723066217456-cf0b10ceda2b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxNXx8bm9uJTIwdmVnJTIwdGhhYWxpfGVufDB8fHx8MTc1NzY2Nzc4Nnww&ixlib=rb-4.1.0&q=80&w=1080', dataAiHint: 'chole bhature' },
  ]
}
